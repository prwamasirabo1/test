...
public class AccountTransaction {
	...
	public AccountTransaction (String custname, String custid) {
	...
	public static void main(String[] args) {
		AccountTransaction obj1 = new AccountTransaction("Patrick", "C001"); 
		obj1.ShowMenue(); 
	}
	...
	void ShowMenue() 
	{
		...
		System.out.println ("Welcome to Bank Of Patrick : "+ customerName); 
